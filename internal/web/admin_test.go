...
// The administration routes that touch the DOCUMENT and the JOURNAL: saving a
// configuration and then applying it, exporting and re-importing it without applying
// anything, restoring a version, reading back the weighings, the technical journal and the
// imports, and recording then forgetting a decision.
//
// The nine troubleshooting buttons, the self-tests and the hardware routes are in
// troubleshooting_test.go, next to troubleshooting.go. The doubles stay here: they already
// served six other test files of this package.
