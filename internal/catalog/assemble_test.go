...
//
// What Assemble DECIDES, and what a source may therefore never decide for itself: an
// unreadable row is counted and the reading carries on, a failed READ refuses the whole
// batch, a twice-used identifier is set aside and named, and a catalog mostly
// unreadable is refused outright by the absolute guard of §10.4.
//
// The photos of an assembly are in photos_test.go.
